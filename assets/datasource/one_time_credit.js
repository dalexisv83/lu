[{
    ...
    "label": "Disaster &ndash; Natural",
    "Credit Name": "Disaster &ndash; Natural",
    "Credit Code": 955,
    ...
    "Application Rules": "<p>See <a href='http://mycsp.web.att.com/mycspportal/proxyServlet?content_matrix_id=myc_ope_cen_eme_538637' target=\"_blank\">Disaster Handling Procedures</a>.</p>",
    "rank": null
}, {
    ...
    "Examples": "<p>Customer was billed for a Mover&rsquo;s fee when comments show fee was to have been waived.</p>",
    ...
    "Examples": "<p>Customer would have been eligible for a larger rebate if they had been activated in a higher package.</p><p>Customer claims they should have received an activation offer but wasn&rsquo;t eligible (i.e. gift cards).</p>",
    ...
    "Examples": "<p>Intended to be used with the <a href='http://mycsp.web.att.com/mycspportal/proxyServlet?content_matrix_id=myc_off_dtv_pro_537389' target=\"_blank\">Dynamic Upgrade Offers</a> (DUOs) or similar Outbound Telemarketing Offers (OBTM). EX:</p><ul><li>Customer accepts $7 off HBO for 3 months, but objects to the partial charge</li></ul>",
    ...
    "Examples": "<p>Customer is disconnecting a premium service (like HBO or Playboy TV) within the first 30 days of adding the service.</p><p>Always check the <a href='http://mycsp.web.att.com/mycspportal/proxyServlet?content_matrix_id=myc_bil_bil_cha_fee_538589' target=\"_blank\">Premium Service Disconnect Fee</a> policy to see if customer will be subject to a fee</p>",
    ...
    "Examples": "<ul><li>Customer objects to a valid service call fee that is already billed to the account.<li>For callback disputes, check the previous call logs to determine if service call was to be discounted.</li></li><li>If a service call was expected to be at $0 and was charged, check to see if issue was Customer caused.</li></ul>",
    "Application Rules": "<ul><li>If a chargeable service call is still open, credit should be issued on the scheduling screen when possible.<ul><li>If credit is not possible, manually copy F9031 in as the service event and use code 150 to apply credit.</li><li>See credit code 199 for instruction on using the scheduling screen.</li></ul></li></ul><p><strong>Do not use for:</strong></p><ul><li><a href='http://mycsp.web.att.com/mycspportal/proxyServlet?content_matrix_id=myc_ser_tv_pro_538646' target=\"_blank\">Service Plus Protection Plan</a> service calls.</li><li>Friends and Family coverage.</li></ul><p><strong>Note:</strong></p><ul><li>If a customer with <a href='http://mycsp.web.att.com/mycspportal/proxyServlet?content_matrix_id=myc_ser_tv_pro_537962' target=\"_blank\">Protection Plan Premier</a> asks about a Service Fee refund, transfer to Technical to have the call handled by a Protection Plan Premier agent.</li></ul>",
    "rank": null
}, {
    "label": "Service Call Credit",
    "Credit Name": "Service Call Credit",
    ...
    "Examples": "<p>Use only as indicated within the <a href='../ecf/ecf.htm' target='_blank'>Lease Agreement / ECF Tool</a>.</p><p>If crediting the ECF when reactivating an account, use the <a href='../activation/index.htm' target='_blank'>Activation tool</a> or see the <a href='http://mycsp.web.att.com/mycspportal/proxyServlet?content_matrix_id=myc_bil_ord_dis_sus_539231' target=\"_blank\">New Reactivation Process</a>. This triggers the credit automatically and reinstates the previous service agreement.</p>",
    "Application Rules": "<p>Auto-defaults when the Cancellation Fee line item (billing code F802) is selected from the Bill Ledger.</p><p>Supervisory Support - Use the <a href='http://mycsp.web.att.com/mycspportal/proxyServlet?content_matrix_id=myc_ope_cen_cal_bil_538605' target=\"_blank\">ECF Waiver Tab</a> to waive the service agreement and prevent the charge from applying if appropriate when disconnecting the account.</p><p>Don't use for the Protection Plan Cancellation Fee. See credit code165 instead.</p>",
    "rank": null
}, {
    ...
    "Examples": "<p>The cancellation fee should only be credited in rare situations. For a list of examples, see <a href='http://mycsp.web.att.com/mycspportal/proxyServlet?content_matrix_id=myc_ser_tv_pro_537675' target=\"_blank\">Protection Plan > Cancel Plan > Complaints about Cancellation Fee</a>.</p>",
    "Application Rules": "<ul><li>Copy F700000009 in as the Service Code. This service code prevents tax adjustments and displays on the bill as 'Reverse Cancel Fee'</li><li>Use credit code 165 &ndash; Protection Plan Cancellation Fee.</li><li>Issue credit for $8 if the customer is in IL, and $10 for all other customers.</li></ul><p><strong>Note:</strong> If a customer with Protection Plan Premier asks about a Service Fee refund, transfer to Technical to have the call handled by a Protection Plan Premier agent.</p>",
    "rank": null
}, {
    ...
    "Examples": "<p>See the <a href='http://mycsp.web.att.com/mycspportal/proxyServlet?content_matrix_id=myc_bil_bil_bil_538583' target=\"_blank\">PPV Billing Issues</a> policy for full call handling steps and use cases.</p>",
    "Application Rules": "<p>Limit of one PPV credit instance per account within a 12-month period.</p><ul><li>For customer disputes and guidance for DISC, COLL, or WROF accounts see <a href='http://mycsp.web.att.com/mycspportal/proxyServlet?content_matrix_id=myc_bil_bil_bil_538583' target=\"_blank\">PPV Billing Issues > Customer Disputes Charge</a>.</li></ul><p>Code 100 auto-defaults when a PPV line item (billing code E) is selected from the Bill Ledger. Manually change the credit code when necessary.</p><ul><li>When sports subscriptions are ordered via IPPV, the first charge applies with an E code. Use code 115 or 120 for sport subscription credits. See <a href='http://mycsp.web.att.com/mycspportal/proxyServlet?content_matrix_id=myc_ope_cen_cal_ord_537575' target=\"_blank\">IPPV Sports Subscriptions</a>.</li></ul>",
    "rank": null
}, {
    "label": "Reage",
    "Credit Name": "Reage",
    ...
    "Examples": "<p>Refer to the <a href='../nrf/nrf.htm' target='_blank'>NRF tool</a>, the <a href='../activation/index.htm' target='_blank'>Activation tool</a>, or see the <a href='http://mycsp.web.att.com/mycspportal/proxyServlet?content_matrix_id=myc_bil_ord_dis_sus_539231' target=\"_blank\">New Reactivation Process</a> for full policy information.</p>",
    "Application Rules": "<ul><li>When an account is being reactivated, agents select if NRFs or ECFs need to be credited while on the <a href='assets/img/rio_1.png' target=\"_blank\">Reactivate screen</a>. When that process is completed, the system reages any NRFs using code191 and cancels the RMAs in OMS, which cause the NRFs to permanently reverse. It also reverses the ECF using code 172 and reinstates the previous service agreement</li><li>See credit code 1006 for rare situations when a manual NRF reage is needed.</li></ul>",
    "rank": null
}, {
    ...
    "Examples": "<p>Refer to the <a href='../nrf/nrf.htm' target='_blank'>NRF tool</a> for steps to resolve all NRFs.</p>",
    "Application Rules": "<ul><li>An NRF reage is a process that refreshes an NRF charge from past due to current. It is usually only necessary at the point of reactivation if there is an error in using the automatic NRF reage process. To complete, select the NRF service event to:</li><ol><li>Apply a credit equal to the outstanding balance due on the account.</li><li>Apply a charge back to the account for the same amount</li><li>The net result should be $0 &ndash; the credit and charge back should be equal.</li></ol><li>See credit code 191 for detail on using the automatic NRF reage process, or see the <a href='../activation/index.htm' target='_blank'>Activation tool</a> or <a href='http://mycsp.web.att.com/mycspportal/proxyServlet?content_matrix_id=myc_bil_ord_dis_sus_539231' target=\"_blank\">New Reactivation Process</a>.</li></ul>",
    "rank": null
}, {
    "label": "Fee Credit",
    ...
    "Examples": "<p>See the <a href='http://mycsp.web.att.com/mycspportal/proxyServlet?content_matrix_id=myc_bil_bil_cha_fee_537756' target=\"_blank\">PTF</a> policy or <a href='http://mycsp.web.att.com/mycspportal/proxyServlet?content_matrix_id=myc_bil_bil_cha_fee_538572' target=\"_blank\">late fee</a> policy for full call handling steps and use cases. </p>",
    "Application Rules": "<ul><li>Credit can be issued anytime the customer is setting up or updating their <a href='http://mycsp.web.att.com/mycspportal/proxyServlet?content_matrix_id=myc_bil_bil_pay_pay_538026' target=\"_blank\">Auto Bill Pay</a>. Always remind customers of their self-care options to make ABP updates.</li><li>For other scenarios, customers are eligible to receive one PTF or late fee credit per rolling 12 month period..</li><li>Use credit code 5203 when crediting the Premium Service Disconnection Fee.</li></ul>",
    "rank": null
}, {
    ...
    "Examples": "<ul></li>See <a href='http://mycsp.web.att.com/mycspportal/proxyServlet?content_matrix_id=myc_equ_adv_acc_537316' target=\"_blank\">Access Card Replacement</a> policy for full call handling steps and use cases.</li>",
    ...
    "Application Rules": "<p>When deciding whether to apply credit, consider customer tenure, reason customer didn't request pre-season cancellation, or other factors to determine best resolution for business and customer.</p><p>Refer to the <a href='http://mycsp.web.att.com/mycspportal/proxyServlet?content_matrix_id=myc_ope_cen_cal_tra_538722' target=\"_blank\">Sports Cancellation Guidelines> In-season</a> guidelines for call handling.</p><ol><li>Comment with amount of credit, reason for credit, and that supervisor approved. </li><li>Disconnect subscription if full credit was applied.</li></ol>",
    "rank": null
}, {
    ...
    "Examples": "<p>See the <a href='http://mycsp.web.att.com/mycspportal/proxyServlet?content_matrix_id=myc_bil_bil_bil_538583' target=\"_blank\">PPV Billing Issues</a> > How to Apply Credit policy for full call handling steps.</p>",
    ...
    "Examples": "<p>See the <a href='http://mycsp.web.att.com/mycspportal/proxyServlet?content_matrix_id=myc_bil_bil_cha_dis_537779' target=\"_blank\">On-Time Service</a> Guarantee (OTG) policy for call handling, triggering the FSR, and eligibility requirements.</p>",
